          ...
          child: Column(
            children: [
              _buildSwitchRow(
                ...
                (val) => setState(() => _isMedicineReminderOn = val),
              ),
              ...
              _buildSwitchRow(
                ...
                'Tóm tắt mỗi tối',
                _isDailyReportOn,
                (val) => setState(() => _isDailyReportOn = val),
              ),
            ],
          ),
        ),
      ...
      child: Row(
        children: [
          Icon(
            icon,
            size: 20,
            color: widget.isDarkMode ? Colors.grey : const Color(0xFF4B5563),
          ),
        ...
        children: [
          Container(
            ...
            child: Icon(
              icon,
              size: 18,
              color: widget.isDarkMode ? Colors.white : const Color(0xFF2563EB),
            ),
          ),
          const SizedBox(width: 12),
          Expanded(
